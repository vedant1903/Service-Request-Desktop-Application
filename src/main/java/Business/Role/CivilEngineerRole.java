 ...
 * @author pranav
 */
public class CivilEngineerRole extends Role{
    @Override
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business, Network network) {
        return new CivilEngineerWorkAreaJPanel(userProcessContainer, account, (PublicWorksOrganization)organization, enterprise, business, network);
    }
}
