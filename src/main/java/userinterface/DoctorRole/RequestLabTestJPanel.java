...
public class RequestLabTestJPanel extends javax.swing.JPanel {
     ...
     */
    public RequestLabTestJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, String type) {
        initComponents();
    ...
    private void callLab(String message)
    {
    ...
    private void callPharmacy(String message)
    {
    ...
    private void requestTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButtonActionPerformed
        ...
        if(type.equals("Lab Organization"))
        {
            callLab(message);
        }
        else if(type.equals("Pharmacist Organization"))
        {
            JOptionPane.showMessageDialog(null, message);
            callPharmacy(message);
        }
